...
###### Check for NAs
Always a good place to start. `NA`s are where good intentions in data management go to die. Make sure you **always** know how many `NA`s there are—and how many there should be.
```{r}
